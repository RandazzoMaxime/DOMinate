...
## Two converted examples

Same protocol as the test loop: Chromium screenshot of the live HTML, then DOMinate PDF rasterized at 96 DPI, then `pixelmatch` (threshold 0.1). Source HTML stays local and is not published.

| | Landing | Invoice |
|---|---:|---:|
| Pixel-diff vs HTML | 1.146% | 0.432% |
| Warm convert | 166 ms | 83 ms |
