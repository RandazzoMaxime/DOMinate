...
|:---:|:---:|
| ![DOMinate landing page rendered as HTML](docs/assets/example-landing-html.png) | ![The same landing page converted to PDF by DOMinate](docs/assets/example-landing-pdf.png) |
